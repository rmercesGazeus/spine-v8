...
var DarkTintBatchGeometry = require('./DarkTintBatchGeometry.js');
var DarkTintShader = require('./DarkTintShader.js');
...
const _DarkTintBatcher = class _DarkTintBatcher extends pixi_js.Batcher {
  constructor() {
    super(...arguments);
    __publicField(this, "geometry", new DarkTintBatchGeometry.DarkTintBatchGeometry());
    __publicField(this, "shader", defaultShader || (defaultShader = new DarkTintShader.DarkTintShader(this.maxTextures)));
...
exports.DarkTintBatcher = DarkTintBatcher;
//# sourceMappingURL=DarkTintBatcher.js.map
