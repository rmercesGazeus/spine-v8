...
class SpineDebugRenderer {
  ...
  drawRegionAttachmentsFunc(spine, debugDisplayObjects, lineWidth) {
    ...
    for (let i = 0, len = slots.length; i < len; i++) {
      ...
      if (attachment === null || !(attachment instanceof spineCore.RegionAttachment)) {
        continue;
      }
  ...
  drawMeshHullAndMeshTriangles(spine, debugDisplayObjects, lineWidth) {
    ...
    for (let i = 0, len = slots.length; i < len; i++) {
      ...
      const attachment = slot.getAttachment();
      if (attachment === null || !(attachment instanceof spineCore.MeshAttachment)) {
        continue;
      }
  ...
  drawClippingFunc(spine, debugDisplayObjects, lineWidth) {
    ...
    for (let i = 0, len = slots.length; i < len; i++) {
      ...
      const attachment = slot.getAttachment();
      if (attachment === null || !(attachment instanceof spineCore.ClippingAttachment)) {
        continue;
      }
  ...
  drawBoundingBoxesFunc(spine, debugDisplayObjects, lineWidth) {
    ...
    const bounds = new spineCore.SkeletonBounds();
  ...
  drawPathsFunc(spine, debugDisplayObjects, lineWidth) {
    ...
    for (let i = 0, len = slots.length; i < len; i++) {
      ...
      const attachment = slot.getAttachment();
      if (attachment === null || !(attachment instanceof spineCore.PathAttachment)) {
        continue;
      }
