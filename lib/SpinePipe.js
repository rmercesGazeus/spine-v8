...
var BatchableSpineSlot = require('./BatchableSpineSlot.js');
...
class SpinePipe {
  ...
  validateRenderable(spine) {
    ...
    if (spine.spineAttachmentsDirty) {
      ...
      for (let i = 0, n = drawOrder.length; i < n; i++) {
        ...
        if (attachment instanceof spineCore.RegionAttachment || attachment instanceof spineCore.MeshAttachment) {
  ...
  addRenderable(spine, instructionSet) {
    ...
    for (let i = 0, n = drawOrder.length; i < n; i++) {
      ...
      if (attachment instanceof spineCore.RegionAttachment || attachment instanceof spineCore.MeshAttachment) {
        const cacheData = spine._getCachedData(slot, attachment);
        const batchableSpineSlot = (_c = gpuSpine.slotBatches)[_d = cacheData.id] || (_c[_d] = new BatchableSpineSlot.BatchableSpineSlot());
...
exports.SpinePipe = SpinePipe;
//# sourceMappingURL=SpinePipe.js.map
